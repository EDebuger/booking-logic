...
public class Restaurant {
    ...
    public Restaurant(Long id, @NonNull String name, @NonNull String adress, @NonNull String postalCode, @NonNull ServiceType serviceType, @NonNull String description, @NonNull Long priceRange, @Nullable BigDecimal rating, @Nullable String image, @NonNull int subOf) {
        this.id = id;
        this.name = name;
        this.adress = adress;
    ...
    public void setRating(@Nullable BigDecimal rating) {this.rating = rating;}
