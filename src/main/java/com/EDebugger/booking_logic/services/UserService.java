...
import com.EDebugger.booking_logic.ExceptionHandlers.GlobalExceptionHandler;
...
public class UserService {
    ...
    public UserService(UserRepository userRepository, GlobalExceptionHandler globalExceptionHandler, PasswordEncoder passwordEncoder) {
...
//    }
    ...
    public @ResponseBody UserProfileforUser createUser(@RequestBody CreateUserDto createUserDto) {
        ...
        if (userRepository.existsByEmail(createUserDto.getEmail())) {
        ...
        else {// Create a NEW User entity and populate from DTO
            User user = new User();
            ...
            UserProfileforUser userDto = convertToUserDTO(savedUser);
            return userDto;} // retrieve entity | transform to dto
    }
