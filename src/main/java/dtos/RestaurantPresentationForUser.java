...
public class RestaurantPresentationForUser {
    ...
    public RestaurantPresentationForUser(Long id, String name, String adress, String postalCode, ServiceType serviceType, String description, Long priceRange, double rating, String image, int subOf) {
        this.id = id;
        this.name = name;
        this.adress = adress;
